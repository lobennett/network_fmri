...
## Task 1: Add strict MechaBABS configuration
...
## Task 2: Add project-owned cluster and app files
...
## Task 3: Create and verify the wrapper study
...
## Task 4: Add the processing adapter and gates
...
## Task 5: Expose the study and processing commands
...
## Task 6: Shorten the raw-data Slurm graph
...
## Task 7: Preserve reviewed decisions during additive migration
...
## Task 8: Validate locally and on a Sherlock pilot
