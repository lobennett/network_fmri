...
Reconstruction requires the exact bases and patch order in the campaign guide, including
the `study_meta.py` helper used to regenerate selection metadata after BIDS changes.
