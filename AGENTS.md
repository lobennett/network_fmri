...
- Production runs on Sherlock, where `/etc/claude-code/CLAUDE.md` is authoritative.
  Run heavy work through Slurm, and verify modules, partitions, and storage rather
  than guessing. Software-only Linux CI is documented in `CONTRIBUTING.md`.
